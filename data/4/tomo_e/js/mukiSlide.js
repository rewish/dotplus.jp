...
(function() {
    ...
    jQuery.mukiSlide = function(config) {
        ...
        // メニューボタンの追加
        var menu = "<ul id=\"menu\">";
        menu += "<li id=\"first\"><img src=\"img/first.png\" alt=\"最初のページへ\" title=\"最初のページへ\" /></li>";
        menu += "<li id=\"prev\"><img src=\"img/prev.png\" alt=\"前のぺーじへ\" title=\"前のぺーじへ\" /></li>";
        menu += "<li id=\"next\"><img src=\"img/next.png\" alt=\"次のページへ\" title=\"次のページへ\" /></li>";
        menu += "<li id=\"last\"><img src=\"img/last.png\" alt=\"最後のページへ\" title=\"最後のページへ\" /></li>";
        menu += "<li id=\"list\"><img src=\"img/list.png\" alt=\"各ページをリスト表示\" title alt=\"各ページをリスト表示\" /></li>";
        menu += "</ul>";
