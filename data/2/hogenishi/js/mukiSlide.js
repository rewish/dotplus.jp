    ...
    $.mukiSlide = function(options){
        ...
        function next() {
            if($('div.select').next().is('div.section')) {
                ...
                $('div.select')[conf.motion]();
            } else {
                $('div.select').removeClass('select');
                $('div.section:visible').hide();
                $('div.section:first').addClass('select')[conf.motion]();
            }
        };
        ...
        function prev() {
            if($('div.select').prev().is('div.section')) {
                ...
                $('div.select').removeClass('select');
                $('div.section:visible').hide();
                $('div.section:last').addClass('select')[conf.motion]();
            }
        };
        ...
        $('ol#listmenu li').click(function() {
            ...
            $('h2').each(function() {
                if(judgeList == $(this).text()) {
                    ...
                    $('div.select').removeClass('select');
                    $('div.section:visible').hide();
                    fitArea.addClass('select')[conf.motion]();
                }
            });
        });
